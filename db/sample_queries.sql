...
INSERT INTO `account-enquiry-db`.`transaction` (`amount`, `currency_id`, `narrative`, `type`, `value_date`, `account_id`) VALUES (100.35, 1, 'test transaction', 1, '2023-03-01', 6);
INSERT INTO `account-enquiry-db`.`transaction` (`amount`, `currency_id`, `narrative`, `type`, `value_date`, `account_id`) VALUES (700.50, 1, 'test transaction', 2, '2023-03-02', 6);
INSERT INTO `account-enquiry-db`.`transaction` (`amount`, `currency_id`, `narrative`, `type`, `value_date`, `account_id`) VALUES (158.45, 1, 'test transaction', 1, '2023-03-03', 4);
